    ...
    return (
        <div id="wd-assignments-editor">
            ...
            <div id="assignmentPoint">
                ...
                <br />
                <div className="row mb-3">
                    <label htmlFor="availableFromDate" className="col-sm-2 col-form-label">Available From</label>
                    <div className="col-sm-10">
                        <input
                            type="datetime-local"
                            className="form-control"
                ...
                <br />
                <div className="row mb-3">
                    <label htmlFor="availableUntilDate" className="col-sm-2 col-form-label">Available Until</label>
                    <div className="col-sm-10">
                        <input
                            type="datetime-local"
                            className="form-control"
            ...
            <div className="mb-3">
                ...
                <button onClick={handleCancel} className="btn btn-lg btn-secondary me-1 float-end">Cancel</button>
            </div>
            <br />
        </div>
    );
